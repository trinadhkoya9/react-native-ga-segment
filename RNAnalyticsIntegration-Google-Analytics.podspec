...
Pod::Spec.new do |s|
  s.name                = "RNAnalyticsIntegration-Google-Analytics"
  ...
  s.description         = <<-DESC
                          ...
                          This is the Google Analytics integration for the React-Native library.
                          DESC
  ...
  s.dependency          'Segment-GoogleAnalytics'
